...
import com.sssms.portal.shared.entity.SubjectRepository;
import com.sssms.portal.shared.entity.YearMetadataRepository;
import com.sssms.portal.shared.utils.PasswordGeneratorUtil;
import com.sssms.portal.features.auth.User;
import com.sssms.portal.features.auth.UserRepository;
import com.sssms.portal.features.faculty.Faculty;
import com.sssms.portal.features.faculty.FacultyRepository;
import com.sssms.portal.features.faculty.ProfessionalDevelopment;
import com.sssms.portal.features.faculty.ProfessionalDevelopmentRepository;
...
import com.sssms.portal.features.student.ScholarshipStatus;
import com.sssms.portal.features.notices.Notice;
import com.sssms.portal.features.notices.NoticeRepository;
import com.sssms.portal.features.notices.TargetRole;
import com.sssms.portal.features.fees.FeeRecord;
import com.sssms.portal.features.fees.FeeRepository;
import com.sssms.portal.features.fees.FeeReminder;
import com.sssms.portal.features.fees.FeeReminderRepository;
...
import com.sssms.portal.features.attendance.AttendanceRecord;
import com.sssms.portal.features.attendance.AttendanceRecordRepository;
import com.sssms.portal.features.attendance.AttendanceSession;
import com.sssms.portal.features.attendance.AttendanceSessionRepository;
import com.sssms.portal.features.results.AcademicMarks;
import com.sssms.portal.features.results.AcademicMarksRepository;
import com.sssms.portal.features.results.Assessment;
import com.sssms.portal.features.results.AssessmentRepository;
import com.sssms.portal.features.results.ClassAssessment;
import com.sssms.portal.features.results.ClassAssessmentRepository;
import com.sssms.portal.features.results.ExamResult;
import com.sssms.portal.features.results.ExamResultRepository;
import com.sssms.portal.features.results.ExamType;
import com.sssms.portal.features.results.StudentMark;
import com.sssms.portal.features.results.StudentMarkRepository;
...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        String[] religions = {"Hindu", "Muslim", "Christian", "Buddhist", "Sikh", "Jain"};
        String[] castes = {"General", "OBC", "SC", "ST"};
        ...
        // Sample father and mother names
        String[] fatherNames = {
            "Suresh Pawar", "Ramesh Shinde", "Vijay Jadhav", "Mohan More", "Prakash Gaikwad",
            "Rajendra Bhosale", "Sanjay Chavan", "Anil Nikam", "Deepak Mane", "Kiran Kadam",
            "Ashok Salunkhe", "Ganesh Desai", "Mahesh Joshi", "Sunil Kulkarni", "Dinesh Sawant",
            "Satish Shete", "Narayan Sonawane", "Bharat Ingale", "Harish Thorat", "Nilesh Kale",
            "Vikas Deshpande", "Umesh Mhatre", "Ravindra Phadke", "Santosh Naik", "Balaji Pol",
            "Sameer Khan", "Dilip Raut", "Manoj Gavali", "Anand Kulkarni", "Vikram Sharma"
        };

        String[] motherNames = {
            "Sunita Pawar", "Kavya Shinde", "Anjali Jadhav", "Priya More", "Dimple Gaikwad",
            "Pooja Bhosale", "Neha Chavan", "Isha Nikam", "Sneha Mane", "Ritika Kadam",
            "Rekha Salunkhe", "Divya Desai", "Swati Joshi", "Rani Kulkarni", "Meera Sawant",
            "Nisha Shete", "Shilpa Sonawane", "Aisha Ingale", "Trisha Thorat", "Simran Kale",
            "Ananya Deshpande", "Shreya Mhatre", "Priyanka Phadke", "Poornima Naik", "Radha Pol",
            "Fiza Khan", "Deepika Raut", "Amrita Gavali", "Bhavna Kulkarni", "Seema Sharma"
        };
        ...
        for (int i = 0; i < 30; i++) {
            ...
            Student sProfile = studentRepository.save(Student.builder()
                ...
                .fathersName(fatherNames[i])
                .mothersName(motherNames[i])
