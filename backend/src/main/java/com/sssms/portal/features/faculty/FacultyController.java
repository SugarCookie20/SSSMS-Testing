...
import com.sssms.portal.features.results.dto.AcademicMarksRequest;
...
public class FacultyController {
    ...
    public ResponseEntity<?> getMySubjects(@AuthenticationPrincipal UserDetails userDetails) {
        ...
        List<Map<String, Object>> response = allocations.stream().map(a -> {
            ...
            map.put("className",
                    a.getSubject().getAcademicYear() != null ? a.getSubject().getAcademicYear().toString() : "N/A");
            map.put("division", "");
            return map;
    ...
    public ResponseEntity<Resource> downloadAttendanceReport(
        ...
        InputStreamResource file = new InputStreamResource(
                facultyService.generateAttendanceCSV(allocationId, start, end));
    ...
    public ResponseEntity<Resource> downloadAttendancePDF(
        ...
        InputStreamResource file = new InputStreamResource(
                facultyService.generateAttendancePDF(allocationId, start, end));
    ...
    public ResponseEntity<?> getStudentProfile(
        ...
        boolean isTeaching = facultyAllocations.stream().anyMatch(allocation -> {
            if (allocation.getSubject().getAcademicYear() == student.getAcademicYear())
                return true;
    ...
    public ResponseEntity<?> saveBatchMarks(@RequestBody List<AcademicMarksRequest> requests) {
    ...
    public ResponseEntity<?> addMyPD(
        ...
        ProfessionalDevelopment pd = ProfessionalDevelopment.builder()
                ...
                .startDate(payload.get("startDate") != null && !payload.get("startDate").isEmpty()
                        ? LocalDate.parse(payload.get("startDate"))
                        : null)
                .endDate(payload.get("endDate") != null && !payload.get("endDate").isEmpty()
    ...
    public ResponseEntity<?> uploadMyPhoto(@AuthenticationPrincipal UserDetails userDetails,
