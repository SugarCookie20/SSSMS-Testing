                        ...
                        {EXAM_TYPES.flatMap(g => g.options).map(opt => (
                            isGraded(opt.value) && (
                                <span key={opt.value}
                                    ...
                                    className={`text-xs px-2.5 py-1 rounded-full cursor-pointer transition-colors flex items-center gap-1 ${examType === opt.value
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div className="p-4 bg-gray-50 border-t flex justify-end">
                    <button
                        ...
                        disabled={saving}
                        className={`text-white px-6 py-2 rounded-lg font-bold disabled:opacity-50 flex items-center ${editMode ? 'bg-orange-600 hover:bg-orange-700' : 'bg-blue-600 hover:bg-blue-700'
                            }`}
                    >
