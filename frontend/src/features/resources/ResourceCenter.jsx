...
import { Upload, FileText, Download, ArrowLeft, CheckCircle, XCircle, Trash2 } from 'lucide-react';
...
const ResourceCenter = () => {
    ...
    const handleUpload = async (e) => {
        e.preventDefault();
        console.log("handleUpload triggered", { hasFile: !!file, hasTitle: !!title, titleLen: title?.length });
