...
import { Bell, Megaphone, Send, Clock, User, CheckCircle, XCircle, Paperclip, Download, Trash2, Timer, ArrowLeft } from 'lucide-react';
                    ...
                    <div key={notice.id} className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                        <div className="flex justify-between items-start mb-2">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className={`text-xs font-medium px-2 py-1 rounded-full flex items-center gap-1 ${notice.expiresAt ? 'bg-amber-50 text-amber-700' : 'bg-green-50 text-green-700'
                                    }`}>
