            ...
            <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm mb-8">
                ...
                <div className="flex gap-4 mb-8">
                    <button
                        ...
                        className={`flex-1 p-4 rounded-lg border-2 flex items-center justify-center font-bold transition-all ${scheduleType === 'CALENDAR'
                    ...
                    <button
                        ...
                        className={`flex-1 p-4 rounded-lg border-2 flex items-center justify-center font-bold transition-all ${scheduleType === 'ACADEMIC'
                                    ...
                                    <td className="px-6 py-4 text-center">
                                        {item.collegeCalendar ? (
                                            <div className="flex items-center justify-center gap-2">
                                                ...
                                                <a
                                                    href={`${BASE_URL}/schedules/view/${item.collegeCalendarFile}`}
                                                    target="_blank"
                                                    rel="noreferrer"
                                    ...
                                    <td className="px-6 py-4 text-center">
                                        {item.academicSchedule ? (
                                            <div className="flex items-center justify-center gap-2">
                                                ...
                                                <a
                                                    href={`${BASE_URL}/schedules/view/${item.academicScheduleFile}`}
                                                    target="_blank"
                                                    rel="noreferrer"
                                                    className="p-1.5 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"
                                                    title="View"
