...
const FeeManagement = () => {
    ...
    const filteredRecords = records.filter(r => {
        ...
        const matchesClass = classFilter === 'ALL' || r.academicYear === classFilter;
            ...
            <div>
                ...
                <div className="mb-6 flex flex-col md:flex-row gap-4">
                    ...
                    <select
                        ...
                        className="p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 outline-none min-w-[150px] bg-white"
                    >
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {filteredRecords.map((record) => (
                                    <tr key={record.studentId} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="p-4">
                                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${record.status === 'PAID' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                                                }`}>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-xl max-w-md w-full border border-gray-200">
                        ...
                        <div className="flex flex-col gap-2 mb-4">
                            <button
                                ...
                                className={`px-4 py-2.5 rounded-lg border text-sm font-medium transition-all ${scholarshipModal.scholarshipStatus === 'NOT_APPLIED'
                            ...
                            <button
                                ...
                                className={`px-4 py-2.5 rounded-lg border text-sm font-medium transition-all ${scholarshipModal.scholarshipStatus === 'APPLIED'
                            ...
                            <button
                                ...
                                className={`px-4 py-2.5 rounded-lg border text-sm font-medium transition-all ${scholarshipModal.scholarshipStatus === 'REJECTED'
