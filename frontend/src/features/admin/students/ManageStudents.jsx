...
const ManageStudents = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto">
            ...
            {/* Status Toast */}
            {status && (
                <div className={`p-4 mb-6 rounded-lg flex items-center border ${status.type === 'success' ? 'bg-green-50 text-green-700 border-green-200' : 'bg-red-50 text-red-700 border-red-200'
                    }`}>
                                        ...
                                        {editingId === student.id ? (
                                            ...
                                            <>
                                                <td className="p-4 font-medium text-gray-900 flex items-center">
                                                    <div className="w-8 h-8 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center mr-3 font-bold text-xs overflow-hidden shrink-0">
                                                        {student.user?.profilePhoto ? (
                                                            <img src={getProfilePhotoUrl(student.user.profilePhoto)} alt="Profile" className="w-full h-full object-cover" />
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 backdrop-blur-sm p-4">
                    <div className="bg-white rounded-xl shadow-xl max-w-lg w-full overflow-hidden flex flex-col max-h-[80vh]">
                        ...
                        <div className="p-6 overflow-y-auto flex-1">
                            {modalStatus && (
                                <div className={`p-3 mb-4 rounded-lg text-sm flex items-center ${modalStatus.type === 'success' ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'
                                    }`}>
