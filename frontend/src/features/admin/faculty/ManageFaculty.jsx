                    ...
                    <div className="overflow-y-auto flex-1 p-2 space-y-2">
                        {facultyList.map(f => (
                            <div
                                ...
                                className={`p-3 rounded-lg cursor-pointer flex items-center justify-between group transition-colors ${selectedFaculty?.id === f.id ? 'bg-blue-50 border border-blue-200' : 'hover:bg-gray-50 border border-transparent'
                                    }`}
                            >
                                <div className="flex items-center overflow-hidden flex-1">
                                    <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center text-gray-500 mr-3 flex-shrink-0 overflow-hidden shrink-0">
                                        {f.profilePhoto ? (
                                            <img src={getProfilePhotoUrl(f.profilePhoto)} alt="Profile" className="w-full h-full object-cover" />
                ...
                <div className="flex-1 bg-white rounded-xl border border-gray-200 shadow-sm p-6 overflow-y-auto">
                    {!selectedFaculty ? (
                        ...
                        <>
                            ...
                            {status.message && (
                                <div className={`p-3 mb-6 rounded-lg text-sm flex items-center ${status.type === 'success' ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'
                                    }`}>
