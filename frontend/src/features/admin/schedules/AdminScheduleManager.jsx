...
import {
    ...
    CheckCircle, XCircle, Users, User, Trash2, Eye, ArrowLeft
} from 'lucide-react';
                ...
                {activeTab === 'timetable' && (
                    <div className="flex gap-4 mb-8">
                        <button
                            ...
                            className={`flex-1 p-4 rounded-lg border-2 flex items-center justify-center font-bold transition-all ${uploadSubType === 'CLASS'
                        ...
                        <button
                            ...
                            className={`flex-1 p-4 rounded-lg border-2 flex items-center justify-center font-bold transition-all ${uploadSubType === 'FACULTY'
            ...
            {(() => {
                const tableConfig = {
                    timetable: {
                        ...
                        viewBase: `${BASE_URL}/timetable/view`,
                        delType: 'timetable',
                    },
                    exam: {
                    ...
                    calendar: {
                        ...
                        viewBase: `${BASE_URL}/schedules/view`,
                        delType: 'calendar',
                    },
                    academic: {
