                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center flex-wrap gap-3 mt-3">
                                        ...
                                        {feeStatus.scholarshipStatus && feeStatus.scholarshipStatus !== 'NOT_APPLIED' && (
                                            <div className={`flex items-center px-3 py-1.5 rounded-lg text-sm font-medium ${feeStatus.scholarshipStatus === 'APPROVED' ? 'bg-green-50 text-green-700 border border-green-200' :
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex items-center flex-wrap gap-3 mt-1">
                                ...
                                {feeStatus.scholarshipStatus && feeStatus.scholarshipStatus !== 'NOT_APPLIED' && (
                                    <span className={`inline-flex items-center text-xs font-medium px-2 py-0.5 rounded-full ${feeStatus.scholarshipStatus === 'APPROVED' ? 'bg-green-100 text-green-700' :
                ...
                {archivedYears.length > 0 && (
                    <div className="flex flex-wrap items-center gap-2 mb-6">
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-colors ${selectedAttYear === null
                        ...
                        {archivedYears.map(y => (
                            <button
                                ...
                                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-colors flex items-center gap-1 ${selectedAttYear === y
                            ...
                            <div key={index} className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                                <div className="flex justify-between mb-4">
                                    ...
                                    <span className={`text-sm font-bold flex items-center ${item.percentage >= 75 ? 'text-green-600' : 'text-red-600'}`}>
                                        {item.percentage >= 75 ? <div></div> : <AlertTriangle className="w-4 h-4 mr-1" />}
                                        {item.percentage}%
                                    </span>
                                </div>
